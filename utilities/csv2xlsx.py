...
def convertCsv2Xlsx(path):
    ...
    new_file_name = input(colored("Provide new filename, press Enter to skip: ", 'light_yellow'))
...
def main():
    ...
    csv_file_path = input(colored("Enter the full path of the CSV file: ", "light_yellow"))
